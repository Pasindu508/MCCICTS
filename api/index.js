...
//
// Vercel serves the Windows 98 web desktop as static files. The rewrite in
// vercel.json routes every request under /api/* to this single function, which
// reuses the exact same request handler as the local dev server
// (server/index.js), so behaviour is identical in both environments.
//
