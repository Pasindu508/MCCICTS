...
Try it [as part of MCCICTS](https://mccicts.lk/) <!--or [standalone](https://mccicts.lk/programs/explorer/)-->

This application functions as both Internet Explorer and Windows Explorer.

### Screenshot

![Screenshot of MCCICTS Explorer window](https://imgur.com/eq8hraU.png)
