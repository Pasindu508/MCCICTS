  ...
  return (
    <section className="relative h-[70vh] bg-black p-4 md:p-6 overflow-hidden flex flex-col">
      ...
      <AnimatePresence mode="wait">
        {isMenuOpen && (
          <MenuOverlay key="about-menu" onClose={() => setIsMenuOpen(false)} />
        )}
      </AnimatePresence>
      ...
      <div className="flex-1 relative mt-2 bg-[#05070a] border border-white/5 rounded-[32px] md:rounded-[40px] overflow-hidden flex flex-col justify-center px-6 sm:px-12 md:px-24 group">
        ...
        <div className="relative z-10 max-w-2xl text-center md:text-left mx-auto md:mx-0">
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl font-light tracking-tight leading-[1.1] text-white mb-4 md:mb-6"
          >
            About Us. <br className="hidden sm:block" />
            <span className="text-white/80">Defining the Future of ICT.</span>
          </motion.h1>
          ...
          >
            We are more than just a society; we are a community of innovators, builders, and dreamers at Mayurapada Central College.
          </motion.p>
        </div>
